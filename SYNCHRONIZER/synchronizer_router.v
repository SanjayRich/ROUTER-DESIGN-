module synchronizer_router(detect_add,data_in,write_enb_reg,clk,reset,
vld_out_0,vld_out_1,vld_out_2,read_enb_0,read_enb_1,read_enb_2,
write_enb,fifo_full,empty_0,empty_1,empty_2,
soft_reset_0,soft_reset_1,soft_reset_2,full_0,full_1,full_2);

// declaring the input and output ports

input detect_add,write_enb_reg,clk,reset,read_enb_0,read_enb_1,read_enb_2,
...
// destination address decoding and sending write_enb signal
...
// soft reset signal generation for each fifo
